...
namespace Lottery_Number_Generator
{
    class Hatoslotto
    {
        ...
        private void SixDrawStory()
        {
            ...
            string text = "What is 'Hatoslottó'?";
            Console.WriteLine(String.Format("{0," + ((Console.WindowWidth / 2) + (text.Length / 2)) + "}", text));
            Console.WriteLine("The 'Hatoslottó' is the six-draw lottery.\n");
            Console.WriteLine("Instead of the word lottery, often the word lotto is used to describe the same game.\n" +
                ...
                "you have a bigger chance to win the grand prize, but still very small.\n");
        ...
        private void SixDrawRules()
        {
            ...
            string text = "What are the rules of 'Hatoslottó'?";
            Console.WriteLine(String.Format("{0," + ((Console.WindowWidth / 2) + (text.Length / 2)) + "}", text));
            Console.WriteLine("The 'Hatoslottó' is the six-draw lottery.\n" +
                "You have to select six numbers out of 45.\n");
            ...
            Console.WriteLine("You win the grand prize if you hit all the 6 numbers,\n" +
                "but win 5,4 and 3 hit you still can get smaller prizes.\n");
            Console.WriteLine("[ BACK ] - PRESS ANY KEY");
